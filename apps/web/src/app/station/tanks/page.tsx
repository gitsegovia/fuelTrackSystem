...
// Inline query: tanks con su última medición incluida
...
function TankCard({ tank, employeeId, refetch }: { tank: any; employeeId: string; refetch: () => void }) {
  ...
  // Última medición (la más reciente por measurementTime)
